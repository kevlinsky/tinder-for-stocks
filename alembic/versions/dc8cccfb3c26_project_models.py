...
Revision ID: dc8cccfb3c26
Revises: 87f53d6e28c2
Create Date: 2021-09-14 00:06:55.440192
...
revision = 'dc8cccfb3c26'
down_revision = '87f53d6e28c2'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('p_e', sa.String(length=1000), nullable=False),
    sa.Column('roa', sa.String(length=1000), nullable=False),
    sa.Column('roe', sa.String(length=1000), nullable=False),
